/**
 * DREAD ELEVEN (DE) — AWWWARDS SITE OF THE YEAR EXPERIENTIAL SSG
 * Flow & Direction: High-Velocity Motorsport & Pro Sports Digital Arenas
 * Palette: Pitch Void (#050507), Acid Volt (#d4ff00), Trophy Gold (#eab308), White (#ffffff)
 * STRICTLY ZERO BLUE • High-Density Film Grain • Kinetic Marquee • 3D Tilt Physics
...
<head>
  ...
  <!-- Contrasting Typography: Syne, Bebas Neue, Plus Jakarta Sans, JetBrains Mono -->
...
<body>
  ...
  <!-- Ambient Fluid Cursor Mesh Glow Canvas -->
...
function renderHeader(activeNav = '') {
  ...
  <div class="espn-broadcast-ribbon" aria-label="Derby Match Ribbon">
    <div class="espn-broadcast-track">
      ${recentMatches.map((m) => {
        ...
        return `
          <a href="/matches/${m.slug}" class="broadcast-match-pill">
            <div class="pill-top-row">
              <span class="pill-format ${isT20 ? 't20' : 'odi'}">${esc(m.format)} • ${m.seasonYear}</span>
              <span class="pill-status ${isDeWin ? 'de-win' : 'des-win'}">
                ${isFinal ? '★ FINAL • ' : ''}${isDeWin ? 'DE WON' : 'DES WON'}
              </span>
            </div>
            <div class="pill-team-line">
              <span>Dread Eleven</span>
              <span class="pill-score ${isDeWin ? 'lead' : ''} tabular">${innDE.runs}/${innDE.wickets}</span>
            </div>
            <div class="pill-team-line">
              <span style="color: #94a3b8;">Destroyers</span>
              <span class="pill-score ${!isDeWin ? 'lead' : ''} tabular">${innDES.runs}/${innDES.wickets}</span>
            </div>
          </a>
        `;
      }).join('')}
  ...
  <header class="site-header">
    <div class="container header-inner">
      <a href="/" class="brand-emblem-link" aria-label="Dread Eleven Home">
        <div class="brand-monogram-box">DE</div>
        <div class="brand-text-block">
          <span class="brand-name-huge">DREAD <span>ELEVEN</span></span>
          <span class="brand-subline">Atal Bihari Vajpayee Memorial Cup • Rewa</span>
        </div>
      </a>
      ...
      <a href="/about" class="btn-header-trophy">
        2022 Champions
      </a>
    </div>
  </header>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="footer-columns-grid">
          <div>
            <div class="brand-name-huge" style="font-size: 2rem; margin-bottom: 0.75rem;">
...
<section class="hero-arena-section">
  <div class="container">
    <div class="hero-layout-grid">
      <div>
        <div class="hero-status-kicker">
        ...
        <h1 class="hero-epic-title">
          ...
          <span class="volt-highlight">DREAD ELEVEN.</span>
        </h1>

        <p class="hero-prose-text">
          Official digital arena of <strong>Dread Eleven (DE)</strong>, anchored by premier opening batsman <strong>Akhil Mishra</strong> (905 runs, 47.6 avg). 
          Champions of the 2022 Silverware and all-time series leaders with <strong>13 victories (54.2% WR)</strong> across 24 One Day &amp; T20 derby clashes against Destroyers Cricket Club under RDCA.
        </p>

        <div class="hero-actions-group">
          <a href="/fixtures" class="btn-volt-primary">
            <span>T20 &amp; One Day Schedule</span>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
          </a>
          <a href="/results" class="btn-titanium-outline">
            <span>24 Match Archive</span>
          </a>
          <a href="/players" class="btn-titanium-outline">
            <span>Roster (43)</span>
          </a>
        </div>
      </div>

      <!-- 3D Gyroscopic Telemetry Monument -->
      <div class="telemetry-stage-card tilt-card">
        <div class="stage-top-strip">
          <span>Atal Bihari Vajpayee Memorial Trophy</span>
          <span style="color: var(--c-gold); font-weight: 800;">CHAMPIONS</span>
        </div>

        <div class="stage-huge-score tabular">
          <span style="color: var(--c-volt);">183</span> <span style="font-size: 1.8rem; color: #64748b;">DEF</span> 162/6
        </div>
        <div class="stage-victory-badge">
          Dread Eleven won 2022 Championship Final by 21 runs
        </div>

        <p class="stage-prose">
          Defending 183 at Martand Ground No. 3, Dread Eleven restricted Destroyers to 162/6 behind lethal pace spells to hoist the coveted silverware.
        </p>

        <div class="stage-metrics-row">
          <div>
            <div class="stage-metric-val tabular" style="color: var(--c-volt);" data-count="13">13</div>
            <div class="stage-metric-lbl">All-Time Derby Wins</div>
          </div>
          <div>
            <div class="stage-metric-val tabular" data-count="905">905</div>
            <div class="stage-metric-lbl">Capt. Akhil Mishra Runs</div>
          </div>
        </div>
      </div>
    </div>
...
<!-- Kinetic Running Marquee (Awwwards Style) -->
<div class="kinetic-marquee-bar" aria-hidden="true">
  <div class="kinetic-track">
    <div class="kinetic-text-item">DREAD ELEVEN <span>•</span> 13 DERBY WINS <span>•</span> 2022 CHAMPIONS <span>•</span> CAPT. AKHIL MISHRA 905 RUNS <span>•</span> RDCA REWA</div>
    <div class="kinetic-text-item outline">TITAN POWERHOUSE <span>•</span> 24 ENCOUNTERS <span>•</span> KULDEEP SEN <span>•</span> KUMAR KARTIKEYA <span>•</span> MARTAND NO. 3</div>
    <div class="kinetic-text-item">DREAD ELEVEN <span>•</span> 13 DERBY WINS <span>•</span> 2022 CHAMPIONS <span>•</span> CAPT. AKHIL MISHRA 905 RUNS <span>•</span> RDCA REWA</div>
    <div class="kinetic-text-item outline">TITAN POWERHOUSE <span>•</span> 24 ENCOUNTERS <span>•</span> KULDEEP SEN <span>•</span> KUMAR KARTIKEYA <span>•</span> MARTAND NO. 3</div>
  </div>
</div>
...
<div class="telemetry-metrics-section">
  <div class="container telemetry-metrics-grid">
    <div class="telemetry-stat-cell">
      <div class="telemetry-stat-num tabular" style="color: var(--c-volt);" data-count="13">13</div>
      <div class="telemetry-stat-lbl">Derby Wins vs Destroyers (54.2% WR)</div>
    </div>
    <div class="telemetry-stat-cell">
      <div class="telemetry-stat-num tabular" data-count="905">905</div>
      <div class="telemetry-stat-lbl">Capt. Akhil Mishra (47.63 Avg • 9 Fifties)</div>
    </div>
    <div class="telemetry-stat-cell">
      <div class="telemetry-stat-num tabular" style="color: var(--c-gold);" data-count="28">28</div>
      <div class="telemetry-stat-lbl">Wickets by Pace Attack (Sen &amp; Das)</div>
    </div>
    <div class="telemetry-stat-cell">
      <div class="telemetry-stat-num tabular" style="color: var(--c-volt);">2022</div>
      <div class="telemetry-stat-lbl">Atal Bihari Vajpayee Memorial Trophy</div>
    </div>
  </div>
</div>
...
<section class="section-wrapper">
  <div class="container">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// SQUAD ARSENAL</div>
        <h2 class="section-title-huge">Active Roster</h2>
      </div>
      <a href="/players" class="btn-volt-primary">Full Squad (43)</a>
    </div>

    <div class="squad-cards-grid">
      ${featuredSquad.map((p) => `
        <a href="/players/${p.slug}" class="player-pro-card tilt-card">
          <div class="player-jersey-huge">#${p.jerseyNumber}</div>
          <div class="player-role-badge">${esc(p.role)}</div>
          <h3 class="player-title-name">${esc(p.name)}</h3>
          <div class="player-caps-text">Dread Eleven • ${p.matches} Matches</div>

          <div class="player-stats-strip">
            <div>
              <div class="player-stat-digit tabular" style="color: var(--c-volt);">${esc(p.batting.runs)}</div>
              <div class="player-stat-desc">Runs</div>
            </div>
            <div>
              <div class="player-stat-digit tabular">${esc(p.batting.average)}</div>
              <div class="player-stat-desc">Avg</div>
            </div>
            <div>
              <div class="player-stat-digit tabular" style="color: var(--c-gold);">${esc(p.bowling.wickets)}</div>
              <div class="player-stat-desc">Wkts</div>
            </div>
          </div>
        </a>
      `).join('')}
...
<!-- Latest Dispatches -->
<section class="section-wrapper" style="background: var(--c-dark-950); border-top: 1px solid var(--b-subtle);">
  <div class="container">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// PRESS RELEASES</div>
        <h2 class="section-title-huge">Tactical Bulletins</h2>
      </div>
      <a href="/news" class="btn-titanium-outline">All Articles</a>
    </div>

    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(340px, 1fr)); gap: 2rem;">
      ${featuredNews.map((n) => `
        <article class="tilt-card" style="background: var(--c-dark-900); border: 1px solid var(--b-medium); border-radius: 6px; padding: 2.25rem; display: flex; flex-direction: column;">
          ...
          <h3 style="font-family: var(--f-hero); font-size: 1.5rem; color: #fff; text-transform: uppercase; line-height: 1.15; margin-bottom: 0.85rem;">
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// ACTIVE ROSTER</div>
        <h1 class="section-title-huge">Dread Eleven Roster (43 Players)</h1>
    ...
    <div style="display: flex; gap: 0.5rem; flex-wrap: wrap; margin-bottom: 2.5rem;" id="squad-filter-controls">
      <button type="button" class="filter-btn active role-btn" data-filter="all">All (43)</button>
      <button type="button" class="filter-btn role-btn" data-filter="Batter">Batters</button>
      <button type="button" class="filter-btn role-btn" data-filter="All-rounder">All-Rounders</button>
      <button type="button" class="filter-btn role-btn" data-filter="Bowler">Bowlers</button>
    </div>

    <div class="squad-cards-grid" id="players-grid">
      ${squad.map((p) => `
        <a href="/players/${p.slug}" class="player-pro-card tilt-card" data-role="${esc(p.role)}">
          <div class="player-jersey-huge">#${p.jerseyNumber}</div>
          <div class="player-role-badge">${esc(p.role)}</div>
          <h2 class="player-title-name">${esc(p.name)}</h2>
          <div class="player-caps-text">Dread Eleven • ${p.matches} Matches</div>
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container">
    ...
    <div style="background: var(--c-dark-900); border: 2px solid var(--b-medium); border-radius: 8px; padding: 2.75rem; margin-bottom: 3rem;">
      ...
      <h1 class="section-title-huge" style="font-size: clamp(2.4rem, 5vw, 4rem); margin-bottom: 0.5rem;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 0.75rem;">
        <div style="background: var(--c-dark-800); border: 1px solid var(--b-subtle); border-radius: 4px; padding: 1rem; text-align: center;">
          <div class="player-stat-desc">Matches</div>
          <div class="player-stat-digit tabular">${p.matches}</div>
        </div>
        <div style="background: var(--c-dark-800); border: 1px solid var(--b-subtle); border-radius: 4px; padding: 1rem; text-align: center;">
          <div class="player-stat-desc">Runs</div>
          <div class="player-stat-digit tabular" style="color: var(--c-volt);">${esc(p.batting.runs)}</div>
        ...
        <div style="background: var(--c-dark-800); border: 1px solid var(--b-subtle); border-radius: 4px; padding: 1rem; text-align: center;">
          <div class="player-stat-desc">HS</div>
          <div class="player-stat-digit tabular">${esc(p.batting.highestScore)}</div>
        </div>
        <div style="background: var(--c-dark-800); border: 1px solid var(--b-subtle); border-radius: 4px; padding: 1rem; text-align: center;">
          <div class="player-stat-desc">Avg</div>
          <div class="player-stat-digit tabular">${esc(p.batting.average)}</div>
        ...
        <div style="background: var(--c-dark-800); border: 1px solid var(--b-subtle); border-radius: 4px; padding: 1rem; text-align: center;">
          <div class="player-stat-desc">SR</div>
          <div class="player-stat-digit tabular">${esc(p.batting.strikeRate)}</div>
        </div>
        <div style="background: var(--c-dark-800); border: 1px solid var(--b-subtle); border-radius: 4px; padding: 1rem; text-align: center;">
          <div class="player-stat-desc">Wkts</div>
          <div class="player-stat-digit tabular" style="color: var(--c-gold);">${esc(p.bowling.wickets)}</div>
        ...
        <div style="background: var(--c-dark-800); border: 1px solid var(--b-subtle); border-radius: 4px; padding: 1rem; text-align: center;">
          <div class="player-stat-desc">BBI</div>
          <div class="player-stat-digit tabular">${esc(p.bowling.bestBowling)}</div>
        </div>
      </div>
    </div>

    <!-- Match Telemetry Table -->
    <div style="background: var(--c-dark-900); border: 1px solid var(--b-medium); border-radius: 6px; padding: 2rem;">
      <h2 style="font-family: var(--f-hero); font-size: 1.6rem; color: #fff; text-transform: uppercase; margin-bottom: 1.5rem;">
          ...
          <tbody>
            ${playerLogs.length ? playerLogs.map((item) => `
              <tr>
                ...
                <td style="padding: 0.85rem 1rem;"><span class="pill-format ${item.match.format === 'T20' ? 't20' : 'odi'}">${esc(item.match.format)}</span></td>
                ...
                <td class="num tabular font-bold" style="color: var(--c-gold);">${item.bowling ? `${item.bowling.wickets}/${item.bowling.runs} (${item.bowling.overs} ov)` : '—'}</td>
                <td style="text-align: center;"><span style="font-family: var(--f-mono); font-size: 0.6875rem; padding: 0.25rem 0.6rem; border-radius: 4px; ${item.match.winner === 'DE' ? 'background: rgba(212, 255, 0, 0.15); color: var(--c-volt);' : 'background: rgba(255, 51, 68, 0.15); color: var(--c-red);'}">${item.match.winner === 'DE' ? 'DE Win' : 'DES Win'}</span></td>
              </tr>
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// ${isResultsPage ? 'RESULTS ARCHIVE' : 'FIXTURES &amp; SCHEDULE'}</div>
        <h1 class="section-title-huge">${isResultsPage ? 'Derby Results &amp; Scorecards' : 'T20 &amp; One Day Fixture Ledger'}</h1>
    ...
    <!-- Multi-Dimensional Filter Command Bar -->
    <div class="filter-command-bar">
      <span class="filter-label">Format:</span>
      <button type="button" class="filter-btn active format-filter-btn" data-format="all">All (${matches.length})</button>
      <button type="button" class="filter-btn format-filter-btn" data-format="T20">T20 Matches (${t20Count})</button>
      <button type="button" class="filter-btn format-filter-btn" data-format="ODI">One-Day / ODI (${odiCount})</button>

      <span class="filter-label" style="margin-left: 1rem;">Season:</span>
      <button type="button" class="filter-btn active season-filter-btn" data-season="all">All Seasons</button>
      <button type="button" class="filter-btn season-filter-btn" data-season="2024">2024</button>
      <button type="button" class="filter-btn season-filter-btn" data-season="2023">2023</button>
      <button type="button" class="filter-btn season-filter-btn" data-season="2022">2022 (Final)</button>
      <button type="button" class="filter-btn season-filter-btn" data-season="2021">2021</button>
    </div>

    <!-- Fixtures Grid -->
    <div class="matches-dynamic-grid" id="fixtures-grid">
      ${matches.map((m) => {
        ...
        return `
          <div class="fixture-pro-card tilt-card" data-format="${esc(m.format)}" data-season="${esc(m.seasonYear)}">
            <div class="card-top-meta">
              <span class="pill-format ${isT20 ? 't20' : 'odi'}">${esc(m.format)} • SEASON ${esc(m.seasonYear)}</span>
            ...
            <div class="card-date-venue">
              <strong style="color: #fff;">${formatDate(m.matchDate)}</strong> • <span>${esc(m.venue.name)}</span>
            </div>

            <div class="card-scoreline-box">
              <div class="scoreline-row">
                <span class="scoreline-name" style="color: ${isDeWinner ? '#fff' : '#64748b'};">Dread Eleven</span>
              ...
              <div class="scoreline-row">
                <span class="scoreline-name" style="color: ${!isDeWinner ? '#fff' : '#64748b'};">Destroyers</span>
            ...
            <div class="card-result-pill ${isDeWinner ? 'de-win' : 'des-win'}">
            ...
            <a href="/matches/${m.slug}" class="btn-titanium-outline" style="margin-top: auto; font-size: 0.75rem; padding: 0.65rem 1rem; text-align: center;">
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container">
    ...
    <div style="background: var(--c-dark-900); border: 2px solid var(--b-medium); border-radius: 8px; padding: 2.5rem; margin-bottom: 2rem;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; flex-wrap: wrap; gap: 1rem;">
        <span class="pill-format ${m.format === 'T20' ? 't20' : 'odi'}">${esc(m.format)} • Season ${esc(m.seasonYear)}</span>
        <span style="font-family: var(--f-mono); font-size: 0.75rem; color: var(--c-volt); font-weight: 700;">${esc(m.stage)}</span>
      </div>

      <h1 class="section-title-huge" style="font-size: clamp(2.2rem, 5vw, 3.5rem); margin-bottom: 0.5rem;">
      ...
      <div style="padding: 0.75rem 1.25rem; border-radius: 4px; font-family: var(--f-body); font-size: 1rem; font-weight: 800; ${isDeWinner ? 'background: rgba(212, 255, 0, 0.15); color: var(--c-volt); border: 1px solid rgba(212, 255, 0, 0.4);' : 'background: rgba(255, 51, 68, 0.15); color: var(--c-red); border: 1px solid rgba(255, 51, 68, 0.4);'}">
        <span>${esc(m.resultText)}</span>
      </div>
    ...
    <div style="display: flex; gap: 0.5rem; border-bottom: 2px solid var(--b-medium); margin-bottom: 2rem;">
      <button type="button" class="filter-btn active espn-tab-btn" data-tab="tab-scorecard" style="border-radius: 4px 4px 0 0;">Scorecard</button>
      <button type="button" class="filter-btn espn-tab-btn" data-tab="tab-matchinfo" style="border-radius: 4px 4px 0 0;">Match Info</button>
    </div>
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// DIVISION STANDINGS</div>
        <h1 class="section-title-huge">Tournament Points Table</h1>
        <p style="color: #94a3b8; font-size: 0.9375rem; margin-top: 0.4rem;">
    ...
    <div style="background: var(--c-dark-900); border: 2px solid var(--b-medium); border-radius: 8px; padding: 2.5rem; margin-bottom: 3rem;">
            ...
            ${pointsTable.allTime.map((row) => `
              <tr>
                ...
                <td style="font-weight: 800; color: #fff; font-size: 1.15rem;">
                  ${esc(row.team)} ${row.rank === 1 ? '<span style="color: var(--c-volt); font-size: 0.75rem; margin-left: 0.5rem;">SERIES LEADER</span>' : ''}
                </td>
                <td class="num tabular font-bold">${row.played}</td>
                <td class="num tabular font-bold" style="color: var(--c-volt);">${row.won}</td>
                <td class="num tabular" style="color: var(--c-red);">${row.lost}</td>
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// PERFORMANCE RECORDS</div>
        <h1 class="section-title-huge">Dread Eleven All-Time Records</h1>
        <p style="color: #94a3b8; font-size: 0.9375rem; margin-top: 0.4rem;">
            ...
            <tbody>
              ${topWicketTakers.map((p) => `
                <tr>
                  <td style="font-weight: 700; color: #fff;"><a href="/players/${p.slug}" style="color: inherit; text-decoration: none;">${esc(p.name)}</a></td>
                  <td class="num tabular">${p.matches}</td>
                  <td class="num tabular font-bold" style="color: var(--c-gold);">${esc(p.bowling.wickets)}</td>
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// PRESS RELEASES</div>
        <h1 class="section-title-huge">Dread Eleven Media Center</h1>
      </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(340px, 1fr)); gap: 2rem;">
      ${news.map((n) => `
        <article class="tilt-card" style="background: var(--c-dark-900); border: 1px solid var(--b-medium); border-radius: 6px; padding: 2.25rem; display: flex; flex-direction: column;">
          ...
          <h2 style="font-family: var(--f-hero); font-size: 1.55rem; color: #fff; text-transform: uppercase; line-height: 1.15; margin-bottom: 0.85rem;">
            <a href="/news/${n.slug}" style="color: inherit; text-decoration: none;">${esc(n.title)}</a>
          </h2>
...
<article class="section-wrapper" style="padding-top: 4rem;">
  <div class="container" style="max-width: 860px;">
    ...
    <h1 class="section-title-huge" style="font-size: clamp(2.4rem, 5vw, 3.8rem); line-height: 1; margin-bottom: 1.5rem;">
      ${esc(n.title)}
    </h1>
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// FRANCHISE HERITAGE</div>
        <h1 class="section-title-huge">About Dread Eleven &amp; 2022 Silverware</h1>
        <p style="color: #94a3b8; font-size: 0.9375rem; max-width: 65ch; margin-top: 0.4rem;">
    ...
    <div style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 3rem; margin-bottom: 3.5rem;">
      <div style="background: var(--c-dark-900); border: 2px solid var(--b-medium); border-radius: 8px; padding: 2.75rem;">
...
<section class="section-wrapper" style="padding-top: 4rem;">
  <div class="container" style="max-width: 960px;">
    <div class="section-head-bar">
      <div>
        <div class="section-kicker-tag">// ADMINISTRATION</div>
        <h1 class="section-title-huge">Contact Dread Eleven</h1>
      </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2.5rem;">
      ...
      <div style="background: var(--c-dark-900); border: 1px solid var(--b-medium); border-radius: 6px; padding: 2rem;">
        ...
        <form onsubmit="event.preventDefault(); alert('Transmission logged. Desk will respond within 24h.');" style="display: flex; flex-direction: column; gap: 1rem;">
          ...
          <button type="submit" class="btn-volt-primary" style="margin-top: 0.5rem; width: 100%; justify-content: center;">
            Submit Transmission
          </button>
        </form>
      </div>
...
<section class="section-wrapper" style="padding: 8rem 0; text-align: center;">
  <div class="container" style="max-width: 600px;">
    ...
    <a href="/" class="btn-volt-primary">Return to Home</a>
  </div>
</section>
...
function main() {
  console.log('=== BUILDING DREAD ELEVEN $4K AWWWARDS MASTERPIECE ===');
  generateHomePage();
  generateSquadPages();
  generateMatchPages();
