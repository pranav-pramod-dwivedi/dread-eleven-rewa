...
const newMatches = [
  ...
  },
  {
    ...
    seasonYear: "2025",
    tournamentName: "Atal Bihari Vajpayee Memorial Tournament",
    stage: "50-Over Championship Final",
    format: "50 Overs",
    status: "completed",
